...
class FormIndex(FlaskForm):
    usuario =  StringField('Usuario',validators=[DataRequired('No dejar vacío, completar'),Length(min=6,max=25)], render_kw={"placeholder": "Nombre de usuario o correo electrónico"})
...
class FormRecuperar(FlaskForm):
    email = EmailField('Email',validators=[DataRequired('No dejar vacío, completar'),Length(min=10,max=40)], render_kw={"placeholder": "Correo de verificación"})
